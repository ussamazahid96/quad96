...
class TD3PG():
    ...
    def __init__(self, args, state_size, action_size, scale=1.):
        ...
        self.batch_size = 64
        self.memory = ReplayBuffer(self.buffer_size, [1,1, self.state_size], self.action_size)
    ...
    def replay(self):
        ...
        states, actions, outputs, rewards, next_states, dones, weights = self.memory.sample(self.batch_size)
